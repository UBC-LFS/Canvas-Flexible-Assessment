...
TEMPLATES = [
    {
        ...
        "DIRS": [
            ...
            os.path.join(BASE_DIR, "..", "accommodations", "templates"),
        ],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
...
SESSION_COOKIE_AGE = (
    30 * 60
)  # set session expiry time to 30 minutes, resets whenever new request is made to page
...
TEAMSHARE_FOLDER = os.environ["TEAMSHARE_FOLDER_FILEPATH"]